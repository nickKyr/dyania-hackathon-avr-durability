...
> Regenerated by `scripts/05_report_synthetic.py` on 2026-09-17, against commit
> `19d9167`. Do not edit the tables by hand: rerun the script, so that what this
...
At the generator's default size of 1,800 patients the cohort is 1,800 patients, 9,216 examinations, 1,334 endpoint rows, 1,800 follow-up records, from seed 20260917. The tables
...
| `as_received` | **no** | 83.8% | 1.62 | 16.2% | 8.55 | 8.55 | **no** |
