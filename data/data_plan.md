...
[`synthetic/results.md`](synthetic/results.md), which is generated by `python -m cohort` and
committed so that the evidence can be read without running anything.*
