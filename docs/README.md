...
5. **Follow-up is thin.** 59 of the 100 operative-report patients have no note after the year of surgery, and 57 have every note in a single calendar year. Only 41 have any note in a later year. Serial echo trajectories per patient are mostly unavailable.
