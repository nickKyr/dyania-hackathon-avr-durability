...
> Generated by `scripts/07_sample_size.py` on 2026-09-17 against commit
> `afdc346 plus uncommitted changes`, in 1 min, on the
...
|---|---|---|---|
| published risk factors only (regression; the floor for the boosted primary model) | 11 | 3,580 | 565 |
...
|---|---|---|---|
| 300 | 31 | 0.720 ± 0.052 | 1.34 |
| 600 | 55 | 0.725 ± 0.067 | 1.20 |
| 1,200 | 105 | 0.774 ± 0.025 | 1.24 |
| 2,400 | 216 | 0.748 ± 0.014 | 1.34 |
| 4,800 | 412 | 0.771 ± 0.010 | 1.15 |

Discrimination improves with size and then flattens: between the smallest and the largest cohort
the AUC moves by +0.051 while its seed-to-seed spread falls from 0.052 to
0.010. **Calibration does not improve at all.** The last column — mean predicted risk
over observed incidence — stays between 1.15 and
1.34 across a sixteen-fold change in sample size, with no trend.
